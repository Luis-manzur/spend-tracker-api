# Generated by Django 4.0.8 on 2022-10-12 13:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('Bank', 'Bank'), ('Cash', 'Cash'), ('Crypto', 'Crypto')], max_length=20)),
                ('balance', models.FloatField(default=0, help_text='Balance summary from account.', verbose_name='Account Balance')),
